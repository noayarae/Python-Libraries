...
def setup_inputs():
    ...
    input_file = parent_folder + "\\data\\dissolvCopy.shp" # <--------  INPUT
    print "Input file: ", input_file
    ...
    list_shpfiles = split_folder(input_file, field_name, outDir) # <------------------  call function
...
def split_folder(input_file, fieldname, outDir):
    ...
    print 'new field "'+ new_fieldname +'" was created...'; print
